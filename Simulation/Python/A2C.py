...
if __name__ == "__main__":
    ...
    # subProcVecEnv: A2C is meant to be run primarily on the CPU, this class makes it so it runs on CPU
    vec_env = make_vec_env('SumoEnv-v1', n_envs=4, vec_env_cls=SubprocVecEnv)
